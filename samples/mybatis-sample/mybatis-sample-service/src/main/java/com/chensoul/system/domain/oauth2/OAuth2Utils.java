 ...
 */
package com.chensoul.system.domain.oauth2;
...
public class OAuth2Utils {
    ...
    public static OAuth2ParamInfo toOAuth2ParamInfo(List<OAuth2Registration> registrations, List<OAuth2Domain> domains, List<OAuth2Mobile> mobiles) {
        ...
        oauth2ParamInfo.setClientRegistrations(registrations.stream().sorted(Comparator.comparing(BaseDataWithExtra::getId)).map(OAuth2Utils::toOAuth2RegistrationInfo).collect(Collectors.toList()));
