...
public class RefreshTokenExpCheckService {
  ...
  @Scheduled(initialDelayString = "#{T(org.apache.commons.lang3.RandomUtils).nextLong(0, ${mail.oauth2.refreshTokenCheckingInterval:86400})}",
          fixedDelayString = "${mail.oauth2.refreshTokenCheckingInterval:86400}",
