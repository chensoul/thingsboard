  ...
  public void refreshAccessToken() {
    ...
    try {
      if (System.currentTimeMillis() > getTokenExpires()) {
        ...
        MailConfiguration mailConfiguration = JacksonUtils.convertValue(settings.getExtra(), MailConfiguration.class);
        ...
        if (MailOauth2Provider.OFFICE_365.name().equals(providerId)) {
          ...
          settings.setExtra(JacksonUtils.readTree(mailConfiguration));
