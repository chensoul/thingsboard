...
import static com.chensoul.json.JacksonUtils.newObjectNode;
...
//	private final NotificationRuleService ruleService;
    ...
    public final void create(String tenantId, DefaultNotification defaultNotification, Long... targets) {
        NotificationTemplate template = defaultNotification.toTemplate();
        template.setTenantId(tenantId);
        template = templateService.saveNotificationTemplate(template);
...
//		}
    ...
    public static class DefaultNotification {
        ...
        public NotificationTemplate toTemplate() {
            ...
            template.setType(type != null ? type : NotificationType.GENERAL);

            NotificationTemplateConfig templateConfig = new NotificationTemplateConfig();
            WebNotificationDeliveryTemplate webTemplate = new WebNotificationDeliveryTemplate();
            ...
            templateConfig.setDeliveryTemplates(Maps.of(
...
//		public NotificationRule toRule(Long templateId, Long... targets) {
...
//				recipientsConfig.setEscalationTable(Map.of(0, toUUIDs(Arrays.asList(targets))));
...
//				recipientsConfig.setTriggerType(rule.getTriggerType());
//				recipientsConfig.setTargets(toUUIDs(Arrays.asList(targets)));
//				rule.setRecipientsConfig(recipientsConfig);
//			}
