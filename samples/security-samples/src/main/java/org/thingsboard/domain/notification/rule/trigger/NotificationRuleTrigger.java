...
public interface NotificationRuleTrigger extends Serializable {
	...
	Serializable getOriginatorEntityId();
	...
	default String getDeduplicationKey() {
		Serializable originatorEntityId = getOriginatorEntityId();
		return String.join(":", getType().toString(), originatorEntityId.toString());
	}
