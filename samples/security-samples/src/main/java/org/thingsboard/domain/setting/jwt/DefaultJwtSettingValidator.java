...
public class DefaultJwtSettingValidator implements JwtSettingValidator {
	...
	public void validate(JwtSetting jwtSetting) {
		...
		if (decodedKey.length * Byte.SIZE < 256 && !JwtSettingService.TOKEN_SIGNING_KEY_DEFAULT.equals(jwtSetting.getTokenSigningKey())) {
