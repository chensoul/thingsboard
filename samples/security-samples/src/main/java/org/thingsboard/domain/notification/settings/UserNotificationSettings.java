 ...
 */
package org.thingsboard.domain.notification.settings;
...
public class UserNotificationSettings {
	...
	public static final Set<NotificationDeliveryType> deliveryMethods = NotificationTargetType.PLATFORM_USER.getSupportedDeliveryTypes();
	...
	public boolean isEnabled(NotificationType notificationType, NotificationDeliveryType deliveryMethod) {
	...
	public static class NotificationPref {
		...
		@NotNull
		private Map<NotificationDeliveryType, Boolean> enabledDeliveryMethods;
