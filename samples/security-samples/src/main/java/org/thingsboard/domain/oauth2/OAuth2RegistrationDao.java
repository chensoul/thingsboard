...
public interface OAuth2RegistrationDao extends Dao<OAuth2Registration> {
	...
	List<OAuth2Registration> findByOAuth2ParamId(Long oauth2ParamId);

	List<OAuth2Registration> findByTenantId(String tenantId);

	String findAppSecret(String id, String pkgName);
