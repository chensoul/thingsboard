...
public class UserNotificationSetting {
	...
	public static final UserNotificationSetting DEFAULT = new UserNotificationSetting(Collections.emptyMap());

	public static final Set<NotificationDeliveryMethod> deliveryMethods = NotificationTargetType.PLATFORM_USER.getSupportedDeliveryTypes();

	@JsonCreator
	public UserNotificationSetting(@JsonProperty("prefs") Map<NotificationType, NotificationPref> prefs) {
		this.prefs = prefs;
	}
