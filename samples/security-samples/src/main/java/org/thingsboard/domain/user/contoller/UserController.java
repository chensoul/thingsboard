...
public class UserController extends BaseController {
	...
	public User getUserById(@PathVariable(USER_ID) Long userId) {
		User user = checkUserId(userId, Operation.GET);
	...
	public JwtPair getUserToken(@PathVariable(USER_ID) Long userId) {
		...
		UserCredential credentials = userService.findUserCredentialsByUserId(userId);
	...
	public User saveUser(@RequestBody User user,
		...
		User oldUser = checkUserId(user.getId(), Operation.POST);
	...
	public void sendActivationEmail(@RequestParam(value = "email") String email,
		...
		accessControlService.checkPermission(getCurrentUser(), Resource.USER, Operation.GET, user.getId(), user);
	...
	public Page<User> getMerchantUsers(Pageable pageable, @PathVariable(MERCHANT_ID) Long merchantId,
		...
		checkMerchantId(merchantId, Operation.GET);
	...
	public void setUserCredentialsEnabled(@PathVariable(USER_ID) Long userId,
		...
		User user = checkUserId(userId, Operation.POST);

		userService.setUserCredentialsEnabled(user.getId(), userCredentialsEnabled);
	}
	...
	public void deleteUserSettings(@Parameter(description = PATHS)
		...
		userSettingService.deleteUserSetting(SecurityUtils.getUserId(), UserSettingType.GENERAL, Arrays.asList(paths.split(",")));
	}
	...
	public void deleteUserSettings(@PathVariable(PATHS) String paths,
								   @PathVariable("type") UserSettingType type) {
		userSettingService.deleteUserSetting(SecurityUtils.getUserId(), type, Arrays.asList(paths.split(",")));
	}
