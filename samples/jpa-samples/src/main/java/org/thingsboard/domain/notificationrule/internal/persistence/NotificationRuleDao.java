...
public interface NotificationRuleDao extends Dao<NotificationRule, Long> {
	List<NotificationRule> findByTenantIdAndTriggerTypeAndEnabled(String tenantId, NotificationRuleTriggerType triggerType, boolean enabled);
}
