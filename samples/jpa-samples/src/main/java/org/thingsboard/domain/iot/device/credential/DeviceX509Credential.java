 ...
 */
public class DeviceX509Credential implements DeviceCredentialFilter {

    private final String sha3Hash;

    public DeviceX509Credential(String sha3Hash) {
    ...
    public DeviceCredentialType getCredentialType() {
        return DeviceCredentialType.X509_CERTIFICATE;
    }

    @Override
    public String toString() {
        return "DeviceX509Credential [SHA3=" + sha3Hash + "]";
    }
}
